...
#define default_is_misclassificaton (query->dm->getBackupError() == MISCLASSIFICATION_ERROR) 

#define default_is_not_misclassification !(query->dm->getBackupError() == MISCLASSIFICATION_ERROR) 

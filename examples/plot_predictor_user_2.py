"""
===========================================
DL8.5 Predictor used for task without label
===========================================
...
print("##############################################################################################################\n"
      "#   DL8.5 Predictor used for clustering task : user specific error function and leaves' values assignation   #\n"
      "##############################################################################################################")
...
clf = DL85Predictor(max_depth=1, error_function=lambda tids: error(tids, X_train), leaf_value_function=lambda tids: leaf_value(tids, X_train), time_limit=600)
